...
class STATICApi {
  ...
  Future<Object> staticBodyTypesGet({ String accept }) async {
    ...
    String path = "/static/body-types".replaceAll("{format}","json");
  ...
  Future<Object> staticCurrenciesGet({ String accept }) async {
    ...
    // create path and map variables
    String path = "/static/currencies".replaceAll("{format}","json");
  ...
  Future<Object> staticCurrencyCoinsGet({ String accept }) async {
    ...
    // create path and map variables
    String path = "/static/currency-coins".replaceAll("{format}","json");
  ...
  Future<Object> staticEthnicitiesGet({ String accept }) async {
    ...
    // create path and map variables
    String path = "/static/ethnicities".replaceAll("{format}","json");
  ...
  Future<Object> staticEyeColorsGet({ String accept }) async {
    ...
    // create path and map variables
    String path = "/static/eye-colors".replaceAll("{format}","json");
  ...
  Future<Object> staticHairColorsGet({ String accept }) async {
    ...
    // create path and map variables
    String path = "/static/hair-colors".replaceAll("{format}","json");
  ...
  Future<Object> staticLanguagesGet({ String accept }) async {
    ...
    // create path and map variables
    String path = "/static/languages".replaceAll("{format}","json");
  ...
  Future<Object> staticLocationsCategoriesEnGet({ String accept }) async {
    ...
    // create path and map variables
    String path = "/static/locations-categories-en".replaceAll("{format}","json");
  ...
  Future<Object> staticSkillsGet({ String accept }) async {
    ...
    // create path and map variables
    String path = "/static/skills".replaceAll("{format}","json");
